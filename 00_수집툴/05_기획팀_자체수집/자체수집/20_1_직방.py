...
if os.path.exists('수집결과\\20_1_직방\\') == False : os.makedirs('수집결과\\20_1_직방\\')
outfilename = '수집결과\\20_1_직방\\직방_{}.txt'.format(today)
outfilename_true = '수집결과\\20_1_직방\\직방_{}.log_성공.txt'.format(today)
outfilename_false = '수집결과\\20_1_직방\\직방_{}.log_실패.txt'.format(today)
