...
def main():
    ...
    outfile = codecs.open('104_빽다방.txt', 'w', 'utf-8')
...
def getStoreInfo(intPageNo):
    url = 'http://theborndb.theborn.co.kr/wp-json/api/get_store/?state=9&category=275&depth1=&depth2=&paged={}&search_string='.format(intPageNo)
