...
def main():
    ...
    outfile = codecs.open('bokjiro1_utf8.txt', 'w', 'utf-8')
    #outfile = codecs.open('bokjiro_test_utf8.txt', 'w', 'utf-8')
        ...
        for gugun_name in sorted(gugun_list):
            ...
            while True:
                ...
                for store in store_list:
                    ...
                    count += 1
                    #if count == 11:     # 같은 결과를 여러번 인쇄하지 않기 위해 (빠뜨리고 인쇄할 위험성 다소 있음)
...
def getStores(sido_name, gugun_name, intPageNo):
    ...
    for i in range(len(entity_list)):
        ...
        if strtemp == 'SB': store_info['type'] = '사회복지시설'
        elif strtemp == 'NY': store_info['type'] = '노인장기요양시설'
        elif strtemp == 'SJ': store_info['type'] = '사회서비스제공기관'
