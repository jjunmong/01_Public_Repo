...
def main():
    ...
    outfile = codecs.open('bokjiro2_2_utf8.txt', 'w', 'utf-8')
    outfile.write("##NAME|SUBNAME|FEAT|ID|TELNUM|NEWADDR|XCOORD|YCOORD@@어린이집\n")
...
def getStores(sido_name, gugun_name, intPageNo):
    ...
    print(len(entity_list)-1)     # for debugging
    ...
    for i in range(len(entity_list)):
        ...
        if strtemp == 'UJ': store_info['type'] = '어린이집'
        elif strtemp == 'UW': store_info['type'] = '유치원'
