...
def main():
    ...
    outfile = codecs.open('libsta1_utf8.txt', 'w', 'utf-8')
    outfile.write("##NAME|SUBNAME|TELNUM|NEWADDR|TYPE|TYPE2|SINCE@@국립도서관\n")

    page = 1
    while True:
        requested_url = 'https://www.libsta.go.kr/libportal/libStats/nationalLib/centerLib/getCenterLibPopAjax.do?gubun=STEP0000000001&dataYear='
        requested_url += '2017'     # 연도
        requested_url += '&searchKeyword=&sido=&siselect=%EC%A7%80%EC%97%AD%EA%B5%AC%EB%B6%84(%EC%A0%84%EA%B5%AD)&sigugunSi=&sigugunGugun=&foundation=&operationMethod=&fixYn=N&libGubun=LIBTYPE001&dhxr1531820898136=1'
