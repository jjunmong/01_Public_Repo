...
def main():
    ...
    outfile = codecs.open('cemetry_ehaneul_all_utf8.txt', 'w', 'utf-8')
    outfile.write("##NAME|SUBNAME|ID|TELNUM|NEWADDR|TYPE|ETC|FEAT|XCOORD|YCOORD|SOURCE2@@묘지\n")
...
def getStores(intPageNo):
    ...
    params = 'facilityDivCd=2&curPageNo=' + str(intPageNo) + '&sidoCd=&gunguCd=&publicCode=&companyName=&latitude=37.5723772025&longitude=127.0142857103'
    print(params)
...
def getStores2(intPageNo):
    ...
    api = '/fnl/fnlFacList.ajax'
    data = {
        'facilityDivCd': '3',   # 1=장례식장, 2=묘지, 3=봉안시설
        'pageInqCnt': '',
        'sidoCd': '',
        'gunguCd': '',
        'publicCode': '',
    ...
    data['curPageNo'] = intPageNo
    params = urllib.urlencode(data)
    params = 'facilityDivCd=3&curPageNo=' + str(intPageNo) + '&sidoCd=&gunguCd=&publicCode=&companyName=&latitude=37.5723772025&longitude=127.0142857103'
    print(params)
...
# 자연장지
def getStores3(intPageNo):
    # 'http://www.ehaneul.go.kr/portal/fnlFac/fnlFacList.do'
    url = 'http://m.ehaneul.go.kr'
    api = '/fnl/fnlFacList.ajax'
    data = {
        'facilityDivCd': '5',   # 1=장례식장, 2=묘지, 3=봉안시설, 5=자연장지
        'pageInqCnt': '',
        'sidoCd': '',
        'gunguCd': '',
        'publicCode': '',
    ...
    data['curPageNo'] = intPageNo
    params = urllib.urlencode(data)
    params = 'facilityDivCd=5&curPageNo=' + str(intPageNo) + '&sidoCd=&gunguCd=&publicCode=&companyName=&latitude=37.5723772025&longitude=127.0142857103'
    print(params)
