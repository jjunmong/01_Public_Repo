...
def main():
    ...
    outfile = codecs.open('skstock_utf8.txt', 'w', 'utf-8')
    outfile.write("##NAME|SUBNAME|ORGNAME|ID|TELNUM|ADDR|NEWADDR|XCOORD|YCOORD@@SK증권\n")
...
def getStores(intPageNo):
    ...
    api = '/main/customer/atm/CU_06000_T01D1.cmd'
    data = {
        'searchVal': '',
        'searchType': '',
        'branch_type': '1',
        'rowPerPage': '15',
        #'_r_': '0.92991238313248',
    }
    data['page'] = intPageNo
    ...
    for i in range(len(entity_list)):
        ...
        store_info['addr'] = entity_list[i]['OLD_ADDRESS']
