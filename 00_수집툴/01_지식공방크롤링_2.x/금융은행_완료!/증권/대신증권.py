...
def main():
    ...
    outfile = codecs.open('daeshinstock_utf8.txt', 'w', 'utf-8')
    outfile.write("##NAME|SUBNAME|TELNUM|NEWADDR@@대신증권\n")
...
def getStores(intPageNo):
    url = 'http://money2.daishin.com'
    api = '/E5/WTS/Company/DW_BranchRouteList.aspx'
    data = {}
