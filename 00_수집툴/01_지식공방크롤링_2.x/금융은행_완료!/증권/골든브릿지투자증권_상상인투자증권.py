...
def main():
    ...
    outfile = codecs.open('stock_goldenbridge_utf8.txt', 'w', 'utf-8')
    outfile.write("##NAME|SUBNAME|TELNUM|NEWADDR@@골든브릿지투자증권\n")
...
def getStores(intPageNo):
    url = 'http://www.bridgefn.com'
    api = '/html/foot_pop/foot_pop04.html'
    data = {}
