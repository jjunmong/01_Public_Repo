...
def main():
    ...
    outfile = codecs.open('nhbank_utf8.txt', 'w', 'utf-8')
...
def getStores(sido_shortname, sido_fullname, intPageNo, count):
    ...
    data = {
        ...
        'c0-id': 0,
        'c0-e1': 'string:1', # 1 = 농협은행 , 2 = 농협은행 + 농*축협 , 3 = 농*축협, 4 = 하나로마트 , 5 = 하나로 클럽
        'c0-e4': 'string:',
        'c0-e5': 'string:3',
        'c0-e6': 'string:',
        #'c0-e7': 'string:5',
