...
def main():
    ...
    outfile = codecs.open('insurance_dongbu_utf8.txt', 'w', 'utf-8')
    outfile.write("##NAME|SUBNAME|TYPE|ID|TELNUM|ADDR|NEWADDR|XCOORD|YCOORD@@동부화재\n")
...
def getStores(sido_name, intPageNo):
    ...
    for i in range(len(entity_list)):
        ...
        store_info['name'] = '동부화재'
        strtemp = entity_list[i]['branch_nm'].lstrip().rstrip()
