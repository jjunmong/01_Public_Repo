...
def main():
    ...
    outfile = codecs.open('toyota_utf8.txt', 'w', 'utf-8')
    outfile.write("##NAME|SUBNAME|ID|TELNUM|NEWADDR|XCOORD|YCOORD@@토요타\n")
...
def getStores(intPageNo, postfix):
    ...
    for i in range(len(entity_list)):
        ...
        store_info['id'] = basic_list['dcode']
