...
def main():
    ...
    outfile = codecs.open('audi_utf8.txt', 'w', 'utf-8')
    outfile.write("##NAME|SUBNAME|SUBNAME2|TELNUM|NEWADDR@@아우디\n")
...
def getStores(type_info):
    ...
    api = '/kr/web/ko/company/dealernetwork.html'
    data = {}
    ...
    for i in range(len(subapi_list)):
        ...
        if not subname.endswith('전시장'): subname += '전시장'
