...
def main():
    ...
    outfile = codecs.open('04_어린이집별기본정보.txt', 'w', 'utf-8')
...
def main2():
    ...
    outfile = codecs.open('어린이집별기본정보.txt', 'a', 'utf-8')
...
def dup_remove():
    w = open('어린이집별기본정보_중복제거.txt', 'w')
    r = open('어린이집별기본정보.txt', 'r',encoding='UTF8')
