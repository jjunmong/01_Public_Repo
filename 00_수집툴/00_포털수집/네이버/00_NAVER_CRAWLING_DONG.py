...
def main():
    ...
    outfile = codecs.open('Crawl_result_dong.txt', 'w', 'utf-8')
...
# def dup_remove():
#     w = open('Crawl_result_dong_중복제거.txt', 'w')
#     r = open('S-Crawl_result_dong.txt', 'r',encoding='UTF8')
...
#     w.close()
#     r.close()
#     os.remove('Crawl_result_dong.txt')
