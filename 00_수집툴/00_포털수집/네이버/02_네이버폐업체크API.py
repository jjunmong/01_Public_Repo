...
def getStoreInfo(inputName):
    ...
    try:
        ...
        list.append({"input": inputName, "id": '찾을수없음', "name": '', "oldaddr": '', "newaddr": '', "tell": '',
                     "cat": '', "xcord": '', "ycord": '', "url": '', "car_ent": '', "walk_ent": '',
                     "menu": '', "time": ''})
    else:
        try: id = data_all['id']
        except : id = ''
        ...
        list.append({"input":inputName,"id":id,"name":name,"oldaddr":oldaddr,"newaddr":newaddr,"tell":tell,"cat":cat,"xcord":xcord,"ycord":ycord,"url":url,"car_ent":car_ent,"walk_ent":walk_ent,"menu":menu,"time":time})
    return list
